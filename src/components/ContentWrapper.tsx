...
export function ContentWrapper({ children }: PropsWithChildren) {
  ...
  return (
    <div className="flex h-full w-full flex-col p-3 pt-20 lg:px-10 lg:pt-10">
      <div className="box-content flex max-h-[40px] items-center justify-center border border-dashed border-neutral-900 px-3 lg:mb-10 lg:py-5">
